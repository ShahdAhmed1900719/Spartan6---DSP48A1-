...
HD_PWD='C:/Users/LAPTOP/Desktop/DEPLOMA/project1/synsis/spartan6/spartan6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spartan6.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spartan6.tcl -notrace
